...
pacman::p_load(data.table, haven, lubridate, here, readxl, tidyverse)
...
The example combines data from household, adult and HBAI files for the years 2021/22 and 2022/23.
...
This section takes start/end years from above and creates the lists used by the function to select the relevant files. 
...
## Combine data
This part needs to be written to suit the join being made i.e. whether it is at household, person or benunit level. NB that 
